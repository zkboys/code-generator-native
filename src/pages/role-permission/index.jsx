...
export default config({
    ...
    const columns = [
        { title: '准许', dataIndex: 'permissionId' },
    ...
    const handleSearch = useCallback(async (options = {}) => {
        ...
        const res = await props.ajax.get('/role_permissions', params, { setLoading });
    ...
    const handleDelete = useCallback(async (id) => {
        await props.ajax.del(`/role_permissions/${id}`, null, { setLoading, successTip: '删除成功！' });
        await handleSearch();
