...
export default config({
    ...
    const columns = [
        { title: '主动规则', dataIndex: 'activeRule' },
        { title: '备注信息', dataIndex: 'description' },
        { title: '进入', dataIndex: 'entry' },
        { title: '名称', dataIndex: 'name' },
        { title: '一边', dataIndex: 'side' },
        {
            title: '操作',
            dataIndex: 'operator',
            width: 150,
    ...
    const handleSearch = useCallback(async (options = {}) => {
        ...
        const res = await props.ajax.get('/sub_apps', params, { setLoading });
    ...
    const handleDelete = useCallback(async (id) => {
        await props.ajax.del(`/sub_apps/${id}`, null, { setLoading, successTip: '删除成功！' });
        await handleSearch();
