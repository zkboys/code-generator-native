...
export default config({
    ...
    const handleSearch = useCallback(async (options = {}) => {
        ...
        const res = await props.ajax.get('/permissions', params, { setLoading });
    ...
    const handleDelete = useCallback(async (id) => {
        await props.ajax.del(`/permissions/${id}`, null, { setLoading, successTip: '删除成功！' });
        await handleSearch();
