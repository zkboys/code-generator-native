...
export default config({
    ...
    const columns = [
        { title: 'r键', dataIndex: 'rKey' },
        { title: 'r值', dataIndex: 'rValue' },
        {
            title: '操作',
            dataIndex: 'operator',
            width: 150,
    ...
    const handleSearch = useCallback(async (options = {}) => {
        ...
        const res = await props.ajax.get('/redis', params, { setLoading });
    ...
    const handleDelete = useCallback(async (id) => {
        await props.ajax.del(`/redis/${id}`, null, { setLoading, successTip: '删除成功！' });
        await handleSearch();
