...
export default config({
    path: '/team_dynamics',
})(function TeamDynamicList(props) {
    ...
    const handleSearch = useCallback(async (options = {}) => {
        ...
        const res = await props.ajax.get('/team_dynamics', params, { setLoading });
    ...
    const handleDelete = useCallback(async (id) => {
        await props.ajax.del(`/team_dynamics/${id}`, null, { setLoading, successTip: '删除成功！' });
        await handleSearch();
