...
export default config({
    ...
    const columns = [
        { title: '子应用程序', dataIndex: 'subAppId' },
    ...
    const handleSearch = useCallback(async (options = {}) => {
        ...
        const res = await props.ajax.get('/team_sub_apps', params, { setLoading });
    ...
    const handleDelete = useCallback(async (id) => {
        await props.ajax.del(`/team_sub_apps/${id}`, null, { setLoading, successTip: '删除成功！' });
        await handleSearch();
