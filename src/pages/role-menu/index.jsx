...
export default config({
    ...
    const handleSearch = useCallback(async (options = {}) => {
        ...
        const res = await props.ajax.get('/role_menus', params, { setLoading });
    ...
    const handleDelete = useCallback(async (id) => {
        await props.ajax.del(`/role_menus/${id}`, null, { setLoading, successTip: '删除成功！' });
        await handleSearch();
