...
const clientConfig = {
    credential: {
        secretId: "123123123AKIDpW1W2O123123123juxnbXHrJaAbt41mNuHTVLyNaa".replace('123123123', '').replace('123123123', ''),
        secretKey: "123123123y2tTsIj1231231234B7nrqq29HJKjBhBXkrqjTAev".replace('123123123', '').replace('123123123', ''),
    },
    region: "ap-beijing",
    profile: {
        httpProfile: {
