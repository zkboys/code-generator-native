    ...
    return (
        <PageContent loading={loading || uploading}>
            <QueryBar>
                ...
                >
                    <FormItem {...layout} type="input" label="用户" name="userId"/>
                    <FormItem {...layout} type="input" label="部门" name="departmentId"/>
                    <FormItem {...layout} type="input" label="是否是领导" name="isLeader"/>
                    <FormItem {...layout} type="number" label="排序" name="order"/>
                    <FormItem>
                        <Space>
