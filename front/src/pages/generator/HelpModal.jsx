        ...
        >
            <Space direction={'vertical'} style={{ width: '100%' }}>
                <Alert
                    ...
                    description={(
                        <ol>
                            <li>安装&更新：npm i @ra-lib/gen --registry=https://registry.npmmirror.com；</li>
                            <li>使用：项目根目录下执行 gen，启动成功后会自动打开浏览器，会在启动目录中创建generator文件夹；</li>
                            <li>编写模版：在命令启动目录/generator/templates文件夹中，可以进行模版编辑，也可以任意添加模版；</li>
                        </ol>
                    )}
                />
                <Alert
